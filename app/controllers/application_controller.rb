class ApplicationController < ActionController::Base
  ...
  include AuthUserConcern
    ...
    def after_sign_in_path_for(resource)
      # binding.pry
      Class.new.send(:include,AccountConcern).new.unlock_account(current_user.account_address,Decrypt_me.call(current_user.key,current_user.salt,current_user.account_password))
