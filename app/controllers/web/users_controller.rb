class Web::UsersController < ApplicationController
  ...
  def movie_detail
    ...
    @sub_categories = SubCategory.find_by(id: @a)
    # binding.pry
    @products_movie_details = (@sub_categories&.products&.published_products-Product.where(id: params[:id]))&.shuffle.take(3)
    #  @product = Product.find_by(id: params[:id])
   ...
   #contract = Contract_instance.call("0xf4a107b44e86fb155632b035375232e341639bea")
